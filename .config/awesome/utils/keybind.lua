...
awful.keyboard.append_global_keybindings({
   ...
   awful.key(
      { Mod, "Control" }, "q",function()
      awful.spawn.with_shell(apps.sysact)
  end,
      {
         description = "sysact",
         group = "launcher"
   ...
   awful.key(
      { Mod,}, "Tab",function()
      awful.spawn.with_shell(apps.password)
  end,
      {
   ...
   awful.key(
      ...
      awful.spawn.with_shell(apps.clipboard)
  end,
      {
   ...
   awful.key(
      { Mod, "Shift" }, "[",function()
      awful.spawn.with_shell(apps.mount)
  end,
      {
         description = "mount",
         group = "launcher"
   ...
   awful.key(
      { Mod, "Shift" }, "]",function()
      awful.spawn.with_shell(apps.unmount)
  end,
      {
         description = "unmount",
         group = "launcher"
   ...
   awful.key(
      { Mod, }, "w",function()
      awful.spawn.with_shell(apps.network)
  end,
      {
...
awful.keyboard.append_global_keybindings({
   ...
   end, { description = 'recorder', group = 'awesome' }
   ),
})
