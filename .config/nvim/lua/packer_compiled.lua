...
_G.packer_plugins = {
  ["DAPInstall.nvim"] = {
    loaded = true,
    path = "/home/mkadit/.local/share/nvim/site/pack/packer/start/DAPInstall.nvim",
  ...
  ["tabby.nvim"] = {
    loaded = true,
    path = "/home/mkadit/.local/share/nvim/site/pack/packer/start/tabby.nvim",
  ...
  ["zen-mode.nvim"] = {
    loaded = true,
    path = "/home/mkadit/.local/share/nvim/site/pack/packer/start/zen-mode.nvim",
