...
_G.packer_plugins = {
  ...
  ["headwind.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/archi/.local/share/nvim/site/pack/packer/opt/headwind.nvim",
  ...
  ["nvim-lsp-ts-utils"] = {
    loaded = true,
    path = "/home/archi/.local/share/nvim/site/pack/packer/start/nvim-lsp-ts-utils",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/archi/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
...
vim.cmd [[au FileType css ++once lua require("packer.load")({'headwind.nvim'}, { ft = "css" }, _G.packer_plugins)]]
vim.cmd [[au FileType svelte ++once lua require("packer.load")({'headwind.nvim'}, { ft = "svelte" }, _G.packer_plugins)]]
